/*****************************************************************************
;
;   (C) ADMtek Incorporated.  All Rights Reserved.
;
;------------------------------------------------------------------------------
;
;    Project : ADM5120
;    Creator : 
;    File    : include/asm/adm5120/adm5120.h
;	 Date    : 2003.3.10
;    Abstract: 
;
...
#define TIMER_IRQ			(ADM5120_IRQ_OFFSET + INT_LVL_TIMER)
#define UART0_IRQ			(ADM5120_IRQ_OFFSET + INT_LVL_UART0)
#define UART1_IRQ			(ADM5120_IRQ_OFFSET + INT_LVL_UART1)
#define USBHOST_IRQ			(ADM5120_IRQ_OFFSET + INT_LVL_USBHOST)
#define EXTIO_0_IRQ			(ADM5120_IRQ_OFFSET + INT_LVL_EXTIO_0)
#define EXTIO_1_IRQ			(ADM5120_IRQ_OFFSET + INT_LVL_EXTIO_1)
#define PCI_INT0_IRQ			(ADM5120_IRQ_OFFSET + INT_LVL_PCI_0)
#define PCI_INT1_IRQ			(ADM5120_IRQ_OFFSET + INT_LVL_PCI_1)
#define PCI_INT2_IRQ			(ADM5120_IRQ_OFFSET + INT_LVL_PCI_2)
#define SWITCH_IRQ			(ADM5120_IRQ_OFFSET + INT_LVL_SWITCH)
...
#define UART_BAUDDIV(_rate)				\
	((unsigned long)(ADM5120_UARTCLK_FREQ/(16*(_rate)) - 1))
...
#define ALLINTS			(IE_IRQ0 | IE_IRQ5)
#define MIPS_CPU_TIMER_IRQ	7
#define ADM5120_IRQ_OFFSET	8
#define ADM5120_IRQ_SIZE	32
#define ADM5120_IRQ_MAX		(ADM5120_IRQ_OFFSET + ADM5120_IRQ_SIZE - 1)
